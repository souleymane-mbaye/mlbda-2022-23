...
-- RM 3.	Quelles sont les pièces composites contenant du bois ?
prompt 'RM3'


-- RM 4.	Quel est le nom des composantes de chaque pièce composite ?
prompt 'RM 4'

-- RM 5.	Quel est le nom de toutes les pièces répertoriées dans la base ?
prompt 'RM 5'
